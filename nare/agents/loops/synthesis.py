...
log = get_logger("nare.agents.loops.synthesis")
...
class VerifiedSynthesisLoop:
    ...
    def _generate_candidate(
        ...
        if not isinstance(candidates[0], dict) or 'solution' not in candidates[0]:
            raise RuntimeError("Generator returned invalid format")
